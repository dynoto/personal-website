...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('photographs_image', 'uploaded', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Image.uploaded'
        db.alter_column('photographs_image', 'uploaded', self.gf('django.db.models.fields.DateField')())
